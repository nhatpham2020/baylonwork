...
@Component({
  selector: 'app-marketmodal',
  templateUrl: './marketmodal.component.html',
  styleUrls: ['./marketmodal.component.css']
})
export class MarketmodalComponent implements AfterViewInit, OnDestroy {
